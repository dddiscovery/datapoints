...
These are still averages over unobserved potential outcomes. But now a tempting shortcut appears: compute the average outcome among treated units (Ȳ₁) and the average among untreated units (Ȳ₀), and use their difference as the estimate. Whether this is valid comes down to one critical question.
